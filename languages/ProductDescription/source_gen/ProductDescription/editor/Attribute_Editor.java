...
public class Attribute_Editor extends DefaultNodeEditor {
  ...
  private EditorCell createCollection_mc4j88_a(EditorContext editorContext, SNode node) {
    ...
    editorCell.addEditorCell(this.createRefNode_mc4j88_c0(editorContext, node));
    return editorCell;
  }
  ...
  private EditorCell createRefNode_mc4j88_c0(EditorContext editorContext, SNode node) {
