...
public class Attribute extends BaseConcept implements INamedConcept {
  public static final String concept = "ProductDescription.structure.Attribute";
  ...
  public static Attribute newInstance(SModel sm, boolean init) {
    return (Attribute) SModelUtil_new.instantiateConceptDeclaration("ProductDescription.structure.Attribute", sm, GlobalScope.getInstance(), init).getAdapter();
  }
