...
public class Date extends BaseConcept {
  public static final String concept = "ProductDescription.structure.Date";
  ...
  public static Date newInstance(SModel sm, boolean init) {
    return (Date) SModelUtil_new.instantiateConceptDeclaration("ProductDescription.structure.Date", sm, GlobalScope.getInstance(), init).getAdapter();
  }
