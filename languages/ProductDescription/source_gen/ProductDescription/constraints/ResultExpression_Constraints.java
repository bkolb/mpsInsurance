...
public class ResultExpression_Constraints extends BaseConstraintsDescriptor {
  private static SNodePointer canBeChildBreakingPoint = new SNodePointer("r:89e43441-0eca-4516-8961-73d762600492(ProductDescription.constraints)", "3975765255154820821");

  public ResultExpression_Constraints() {
    super("ProductDescription.structure.ResultExpression");
  }
  ...
  public static boolean static_canBeAChild(final IOperationContext operationContext, final CanBeAChildContext _context) {
    return (SNodeOperations.getAncestor(_context.getParentNode(), "ProductDescription.structure.CompositeProductType", true, false) != null);
  }
}
